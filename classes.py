class Television:
    ...
    def __init__(self, __channel: int, __volume: int, __status: bool) -> None:
        ...
        :param self.__status: the boolean value of 'True' or 'False', which describes if the television is powered
        """
